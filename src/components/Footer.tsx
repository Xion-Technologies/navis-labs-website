...
const footerLinks = {
  ...
  Solutions: [
    ...
    { label: "Booking System", href: "/solutions#booking" },
    { label: "Data Management", href: "/solutions#data-management" },
    { label: "AI Chatbot", href: "/solutions#ai-chatbot" },
    { label: "Support Modules", href: "/solutions#support-modules" },
    { label: "Custom Systems", href: "/solutions#custom-system" },
  ],
  "Get in Touch": [
      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
              ...
              <ul className="space-y-1">
                {links.map((link) => (
                  <li key={link.label}>
                    <Link
                      to={link.href}
                      className="inline-block py-1.5 text-sm text-neutral-dark transition-colors hover:text-teal"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-white/5 pt-8 md:flex-row">
          <p className="text-sm text-neutral-dark">
            &copy; 2026 Navis Labs. All rights reserved.
          </p>
          <div className="flex gap-4">
            {/* LinkedIn */}
            <a
              href="#"
              className="text-neutral-dark transition-colors hover:text-teal"
              aria-label="LinkedIn"
            >
